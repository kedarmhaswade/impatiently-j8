 ...
 * Every event has a start point and and end point (both are integers for now). If an event
 * ends when another starts, then they are not happening concurrently.
 * </p>
 * <p>
