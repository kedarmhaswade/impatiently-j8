 ...
 * Find the subset of the given set of numbers whose numbers sum up to a given number.
 */
...
//        subsetHasSum(new int[] {15, 9, 30, 21, 19, 3, 12, 6, 25, 27}, 50); // This is Sam Loyd Puzzle!
    }
